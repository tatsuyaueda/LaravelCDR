...
@section('content')
                        ...
                        <div class="box-body">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control input-sm" name="id" id="inputId"
                                               value="{{old('id', $record->id)}}" placeholder="グループID"
                                               readonly="readonly">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control input-sm" name="group_name"
                                               id="inputName" value="{{old('group_name', $record->group_name)}}"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            @if(old('parent_groupid', $record->parent_groupid))
